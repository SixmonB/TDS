...
#ifndef LIBRARIES_STM32F4XX_HAL_DRIVER_INC_STM32F4XX_STD_DMA_H_
#define LIBRARIES_STM32F4XX_HAL_DRIVER_INC_STM32F4XX_STD_DMA_H_
...
#define IS_DMA_CHANNEL_STD(CHANNEL) (((CHANNEL) == DMA_Channel_0) || \
...
#define IS_DMA_DIRECTION_STD(DIRECTION) (((DIRECTION) == DMA_DIR_PeripheralToMemory ) || \
...
#define IS_DMA_PERIPHERAL_INC_STATE_STD(STATE) (((STATE) == DMA_PeripheralInc_Enable) || \
...
#define IS_DMA_MEMORY_INC_STATE_STD(STATE) (((STATE) == DMA_MemoryInc_Enable) || \
...
#define IS_DMA_PERIPHERAL_DATA_SIZE_STD(SIZE) (((SIZE) == DMA_PeripheralDataSize_Byte)  || \
...
#define IS_DMA_MEMORY_DATA_SIZE_STD(SIZE) (((SIZE) == DMA_MemoryDataSize_Byte)  || \
...
#define IS_DMA_MODE_STD(MODE) (((MODE) == DMA_Mode_Normal ) || \
...
#define IS_DMA_PRIORITY_STD(PRIORITY) (((PRIORITY) == DMA_Priority_Low )   || \
...
#define IS_DMA_FIFO_MODE_STATE_STD(STATE) (((STATE) == DMA_FIFOMode_Disable ) || \
...
#define IS_DMA_FIFO_THRESHOLD_STD(THRESHOLD) (((THRESHOLD) == DMA_FIFOThreshold_1QuarterFull ) || \
...
#define IS_DMA_MEMORY_BURST_STD(BURST) (((BURST) == DMA_MemoryBurst_Single) || \
...
#define IS_DMA_PERIPHERAL_BURST_STD(BURST) (((BURST) == DMA_PeripheralBurst_Single) || \
...
/** @defgroup DMA_interrupt_enable_definitions
  * @{
  */
#define DMA_IT_TC_STD                         ((uint32_t)0x00000010)
#define DMA_IT_HT_STD                         ((uint32_t)0x00000008)
#define DMA_IT_TE_STD                         ((uint32_t)0x00000004)
#define DMA_IT_DME_STD                        ((uint32_t)0x00000002)
#define DMA_IT_FE_STD                         ((uint32_t)0x00000080)
...
/** @defgroup DMA_interrupts_definitions
  * @{
  */
#define DMA_IT_FE_STDIF0                      ((uint32_t)0x90000001)
#define DMA_IT_DME_STDIF0                     ((uint32_t)0x10001004)
#define DMA_IT_TE_STDIF0                      ((uint32_t)0x10002008)
#define DMA_IT_HT_STDIF0                      ((uint32_t)0x10004010)
#define DMA_IT_TC_STDIF0                      ((uint32_t)0x10008020)
#define DMA_IT_FE_STDIF1                      ((uint32_t)0x90000040)
#define DMA_IT_DME_STDIF1                     ((uint32_t)0x10001100)
#define DMA_IT_TE_STDIF1                      ((uint32_t)0x10002200)
#define DMA_IT_HT_STDIF1                      ((uint32_t)0x10004400)
#define DMA_IT_TC_STDIF1                      ((uint32_t)0x10008800)
#define DMA_IT_FE_STDIF2                      ((uint32_t)0x90010000)
#define DMA_IT_DME_STDIF2                     ((uint32_t)0x10041000)
#define DMA_IT_TE_STDIF2                      ((uint32_t)0x10082000)
#define DMA_IT_HT_STDIF2                      ((uint32_t)0x10104000)
#define DMA_IT_TC_STDIF2                      ((uint32_t)0x10208000)
#define DMA_IT_FE_STDIF3                      ((uint32_t)0x90400000)
#define DMA_IT_DME_STDIF3                     ((uint32_t)0x11001000)
#define DMA_IT_TE_STDIF3                      ((uint32_t)0x12002000)
#define DMA_IT_HT_STDIF3                      ((uint32_t)0x14004000)
#define DMA_IT_TC_STDIF3                      ((uint32_t)0x18008000)
#define DMA_IT_FE_STDIF4                      ((uint32_t)0xA0000001)
#define DMA_IT_DME_STDIF4                     ((uint32_t)0x20001004)
#define DMA_IT_TE_STDIF4                      ((uint32_t)0x20002008)
#define DMA_IT_HT_STDIF4                      ((uint32_t)0x20004010)
#define DMA_IT_TC_STDIF4                      ((uint32_t)0x20008020)
#define DMA_IT_FE_STDIF5                      ((uint32_t)0xA0000040)
#define DMA_IT_DME_STDIF5                     ((uint32_t)0x20001100)
#define DMA_IT_TE_STDIF5                      ((uint32_t)0x20002200)
#define DMA_IT_HT_STDIF5                      ((uint32_t)0x20004400)
#define DMA_IT_TC_STDIF5                      ((uint32_t)0x20008800)
#define DMA_IT_FE_STDIF6                      ((uint32_t)0xA0010000)
#define DMA_IT_DME_STDIF6                     ((uint32_t)0x20041000)
#define DMA_IT_TE_STDIF6                      ((uint32_t)0x20082000)
#define DMA_IT_HT_STDIF6                      ((uint32_t)0x20104000)
#define DMA_IT_TC_STDIF6                      ((uint32_t)0x20208000)
#define DMA_IT_FE_STDIF7                      ((uint32_t)0xA0400000)
#define DMA_IT_DME_STDIF7                     ((uint32_t)0x21001000)
#define DMA_IT_TE_STDIF7                      ((uint32_t)0x22002000)
#define DMA_IT_HT_STDIF7                      ((uint32_t)0x24004000)
#define DMA_IT_TC_STDIF7                      ((uint32_t)0x28008000)

#define IS_DMA_CLEAR_IT(IT) ((((IT) & 0x30000000) != 0x30000000) && \
                             (((IT) & 0x30000000) != 0) && ((IT) != 0x00) && \
                             (((IT) & 0x40820082) == 0x00))

#define IS_DMA_GET_IT(IT) (((IT) == DMA_IT_TC_STDIF0) || ((IT) == DMA_IT_HT_STDIF0)  || \
                           ((IT) == DMA_IT_TE_STDIF0) || ((IT) == DMA_IT_DME_STDIF0) || \
                           ((IT) == DMA_IT_FE_STDIF0) || ((IT) == DMA_IT_TC_STDIF1)  || \
                           ((IT) == DMA_IT_HT_STDIF1) || ((IT) == DMA_IT_TE_STDIF1)  || \
                           ((IT) == DMA_IT_DME_STDIF1)|| ((IT) == DMA_IT_FE_STDIF1)  || \
                           ((IT) == DMA_IT_TC_STDIF2) || ((IT) == DMA_IT_HT_STDIF2)  || \
                           ((IT) == DMA_IT_TE_STDIF2) || ((IT) == DMA_IT_DME_STDIF2) || \
                           ((IT) == DMA_IT_FE_STDIF2) || ((IT) == DMA_IT_TC_STDIF3)  || \
                           ((IT) == DMA_IT_HT_STDIF3) || ((IT) == DMA_IT_TE_STDIF3)  || \
                           ((IT) == DMA_IT_DME_STDIF3)|| ((IT) == DMA_IT_FE_STDIF3)  || \
                           ((IT) == DMA_IT_TC_STDIF4) || ((IT) == DMA_IT_HT_STDIF4)  || \
                           ((IT) == DMA_IT_TE_STDIF4) || ((IT) == DMA_IT_DME_STDIF4) || \
                           ((IT) == DMA_IT_FE_STDIF4) || ((IT) == DMA_IT_TC_STDIF5)  || \
                           ((IT) == DMA_IT_HT_STDIF5) || ((IT) == DMA_IT_TE_STDIF5)  || \
                           ((IT) == DMA_IT_DME_STDIF5)|| ((IT) == DMA_IT_FE_STDIF5)  || \
                           ((IT) == DMA_IT_TC_STDIF6) || ((IT) == DMA_IT_HT_STDIF6)  || \
                           ((IT) == DMA_IT_TE_STDIF6) || ((IT) == DMA_IT_DME_STDIF6) || \
                           ((IT) == DMA_IT_FE_STDIF6) || ((IT) == DMA_IT_TC_STDIF7)  || \
                           ((IT) == DMA_IT_HT_STDIF7) || ((IT) == DMA_IT_TE_STDIF7)  || \
                           ((IT) == DMA_IT_DME_STDIF7)|| ((IT) == DMA_IT_FE_STDIF7))
/**
  * @}
  */
...
#endif /* LIBRARIES_STM32F4XX_HAL_DRIVER_INC_STM32F4XX_STD_DMA_H_ */
